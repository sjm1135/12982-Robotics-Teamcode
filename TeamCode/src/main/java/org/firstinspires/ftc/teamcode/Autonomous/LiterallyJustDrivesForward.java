...
@Autonomous(name = "literally_just_drives_forward")
public class LiterallyJustDrivesForward extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDriveForward(1.5, WHEEL_POWER); // Drive Forward
    }
